...
const Cart=({ count, items, onHandleEvent })=>{
    ...
    const handleModal=()=>{
        setShowModal(previousSatae => !previousSatae)
    }
    ...
    return(
        <Fragment>
            <button onClick={handleModal}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-shopping-cart-plus" width="20" height="20" viewBox="0 0 24 24" strokeidth="1.5" stroke="white" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <h4>
                                        {
                                          ...
                                          <span style={{marginLeft:"4px"}}></span>INR</h4>
                                </div>
